...
module.exports = function (grunt) {
  ...
  var jsFilesToInject = [
    ...
    'linker/js/lib/marionette.formview.min.js',
    'linker/js/lib/backbone.sailsjs.js',
    'linker/js/lib/backbone.view-model.js',
    
    'linker/js/app/init.js',
    'linker/js/app/models/**/*.js',
    'linker/js/app/collections/**/*.js',
  
    'linker/js/app/views/users/*.js',
    'linker/js/app/views/tweets/show.js',
    'linker/js/app/views/tweets/*.js',
    'linker/js/app/views/hash_tags/show.js',
    'linker/js/app/views/tweets/*.js',
    'linker/js/app/views/**/*.js',
    'linker/js/app/layout_manager.js',
    'linker/js/app/controllers/**/*.js',
    'linker/js/app/routes.js',
